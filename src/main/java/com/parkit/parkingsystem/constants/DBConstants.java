...
public class DBConstants {
    ...
    /**
     * The constant CLIENT_OCCURENCY.
     */
    public static final String CLIENT_OCCURENCY = "select count(*) from ticket where VEHICLE_REG_NUMBER=? and price <> 0";
    /**
     * The constant CLIENT_TOTAL_SPENT.
     */
    public static final String CLIENT_TOTAL_SPENT = "select sum(price) from ticket where VEHICLE_REG_NUMBER=?";
}
